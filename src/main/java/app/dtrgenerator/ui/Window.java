...
public class Window extends JFrame {
        ...
        private void initComponents() {
                ...
                this.lblCutOff = (JLabel) new ComponentBuilder().setText(Constant.LBL_CUTOFF)
                                .build(ComponentType.LABEL);
                ...
                this.lblExcelPath = (JLabel) new ComponentBuilder().setText(Constant.LBL_EXCEL_PATH)
                                .build(ComponentType.LABEL);
                ...
                this.lblSavePath = (JLabel) new ComponentBuilder().setText(Constant.LBL_SAVE_PATH)
                                .build(ComponentType.LABEL);
                this.txtSavePath = (JTextField) new ComponentBuilder().setTooltip(Constant.SAVE_PATH_TOOLTIP)
                                .setEnabled(false).build(ComponentType.TEXT_FIELD);
        ...
        private void initLayout() {
                ...
                layout.setHorizontalGroup(layout.createSequentialGroup().addGroup(layout
                                .createParallelGroup(Alignment.CENTER).addComponent(this.lblTitle)
                ...
                layout.setVerticalGroup(layout.createSequentialGroup().addGap(20, 20, 20).addComponent(this.lblTitle)
                                .addGap(20, 20, 20)
        ...
        public void export() {
                try {
                        ...
                        this.displayMessage(Constant.SUCCESS_TITLE,
                                        fileSavePath.getFileName().toString() + Constant.SUCCESS_MESSAGE,
